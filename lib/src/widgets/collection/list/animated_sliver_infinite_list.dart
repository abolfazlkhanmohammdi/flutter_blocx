...
class AnimatedSliverInfiniteList<Entity extends BlocxBaseEntity>
...
class AnimatedSliverBlocxInfiniteListState<Entity extends BlocxBaseEntity>
  ...
  late final String uuid =
      'AnimatedSliverInfiniteList-${identityHashCode(this)}';
  ...
  Widget _buildAnimatedList(
    ...
    return SliverImplicitlyAnimatedList<Entity>(
      ...
      itemBuilder: (c, data) =>
          _animatedItemWithOptionalSeparator(c, data, state),
